...
- Plan implementation with `zen:planner` command
- Obtain the list of commands from Serena MCP. Use them to assist you in implementing the task and traversing codebase, including `serena:find_symbol` and `serena:search_for_pattern`
- Iterate over subtasks:
  1. Pick the next incomplete subtask.
  2. Implement the required changes, consulting docs as needed. consulting docs as needed. Use `zen:debug` to resolve any issues.
